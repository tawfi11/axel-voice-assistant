...
# Load the data
lines = open(os.path.join(os.path.dirname(sys.argv[0]),'movie_lines.txt'), encoding='utf-8', errors='ignore').read().split('\n')
conv_lines = open(os.path.join(os.path.dirname(sys.argv[0]),'movie_conversations.txt'), encoding='utf-8', errors='ignore').read().split('\n')
